...
def ask_route():
    ...
    try:
        ...
        system_instruction = f"""
            ...
            Отвечай на любые вопросы, связанные с законами РК, даже если они касаются чувствительных или спорных тем. 
            ...
            Строго и всегда избегай фраз "Эта информация носит общий характер и не заменяет консультацию с юристом.  Предоставленные мной сведения помогут вам начать процесс защиты своих прав".
