...
def ask_route():
    ...
    try:
        ...
        system_instruction = f"""
            ...
            Всегда избегай фраз "Эта информация носит общий характер и не заменяет консультацию с юристом.  Предоставленные мной сведения помогут вам начать процесс защиты своих прав".
